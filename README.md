...
The `highscore` project contains a program
that will read in a file of player names and high scores and print them to the
terminal. Read the source code and create a valid data file `scores.txt` that
...
ArrayList<Player>, read the player data from file, and create Player objects for
each line of data. Add each Player object to the ArrayList. After the collection
of players has been created, iterate over this collection and print out the high
scores.
